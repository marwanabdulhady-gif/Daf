...
<section class="section" id="all-lessons">
  ...
  <p class="intro"><b>Implementation has started:</b> lesson 1-1 is the first built pilot with Omar, Zayd, folio progress, a civic-data mission, source-checked STEM history and a mathematical handoff. The remaining entries are the approved authoring map. Every lesson has its own recommended screen count and planning band.</p>
