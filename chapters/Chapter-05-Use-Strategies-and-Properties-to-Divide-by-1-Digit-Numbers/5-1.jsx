...
const LESSON = {
  ...
  Visual: function ({ i, award, game }) {
    ...
    switch (i) {
      case 0:
        return (
          <StoryShell lane="fiction" character="lantern" support="mansur"
            title="Loads that divide cleanly"
            text="The caravan's first crates come out even: 12, 120, 1,200, 12,000 — all shared by 4. The 3 is always there. Mansur, the caravan master, counts nothing twice."
